...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/10/07 11:07:45 by imhaimou          #+#    #+#             */
/*   Updated: 2018/10/07 19:07:24 by piquerue         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					inst_lldi(t_corewar *core, t_warrior *warr, t_vproc *proc)
{
	uint8_t			*mem;
	int32_t			param[3];
	int32_t			type[3];
